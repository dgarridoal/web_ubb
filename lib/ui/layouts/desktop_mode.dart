...
class DesktopMode extends StatelessWidget {
  final Widget child;
  const DesktopMode({Key? key, required this.child}) : super(key: key);
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () => irAWeb(
                            'https://download1336.mediafire.com/2ls4vi8wcrxg/mk7l8jlmu04fzkj/Malla+ICI+2957-1.pdf+%C2%B7+versio%CC%81n+1.pdf'),
                        child: MouseRegion(
